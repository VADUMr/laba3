...
public class HelloController {
    ...
    protected void onClickMethod() {
        ...
        String pr_1 = storona_1.getText();
        String pr_2 = storona_2.getText();
        String pr_3 = storona_3.getText();
        if(!(pr_1.isEmpty() && pr_2.isEmpty() && pr_3.isEmpty())) {
            volume_pr.setText(String.valueOf(Double.parseDouble(storona_1.getText())*Double.parseDouble(storona_2.getText()) * Double.parseDouble(storona_3.getText())));
            area_pr.setText(String.valueOf(2  * (Double.parseDouble(storona_1.getText())*Double.parseDouble(storona_2.getText())+
                    Double.parseDouble(storona_1.getText())*Double.parseDouble(storona_3.getText())+
                    Double.parseDouble(storona_2.getText())*Double.parseDouble(storona_3.getText()))));
        }
    }
}